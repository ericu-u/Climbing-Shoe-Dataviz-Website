...
function showDescription(buttonId) {
  ...
  if (buttonId == "climbingButton") {
    var addedDescription = document.createTextNode(
    ...
    newCap.innerHTML =
      'La Sportiva Tarantulace Climbing Shoes. From \
  ...
  if (buttonId == "hikingButton") {
    ...
    newCap.innerHTML =
      'La Sportiva TX Guide Approach Shoes - Men\'s. From \
  ...
  if (buttonId == "rockclimbingButton") {
    ...
    newCap.innerHTML =
      'TENAYA Tarifa Climbing Shoes. From \
  ...
  var scatter = new Highcharts.Chart("scatter", {
    ...
    plotOptions: {
      scatter: {
        ...
        tooltip: {
          pointFormat:
            "<b>{point.name}:</b><br><b>${point.x}, {point.y} Stars</b>",
          enabled: true,
        },
        cursor: "pointer",
        events: {
